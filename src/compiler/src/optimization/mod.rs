...
use crate::{
    ...
    optimization::{
        combinators::{RepeatUntilConvergence, push_to_pull},
        local::{
            CoalesceAdds, Peephole, RemoveDeadCode, RemoveUselessJumps, RepeatUntil1, RepeatUntil2,
...
impl PartialEq for OptimizingPrimitive {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            ) => l_puzzle == r_puzzle && ptr::eq::<Architecture>(&raw const **l_arch, &raw const **r_arch) && l_amts == r_amts,
            (
                Self::AddTheoretical {
        ...
        (
            ...
            (
                ...
                (
                    ...
                    (Peephole<RepeatUntil3>, TransformSolve),
                ),
            ),
        ),
    ),
