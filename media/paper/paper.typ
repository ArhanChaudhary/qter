...
#let cube(faces, offset: (0, 0), scale-amt: 1, back: false, name: "") = {
  ...
  group(name: name, {
    ...
    for (x, (facelets, transform)) in faces.zip(transforms).enumerate() {
      group({
        transform

        for i in range(0, by) {
          for j in range(0, by) {
            let (fill, stroke) = facelets.at((by - 1) - i + j * by)
            rect((i + 0.03, j + 0.03), (i + 0.97, j + 0.97), radius: .2, fill: fill, stroke: stroke)
          }
        }

        if back and x == 2 {
          merge-path(fill: black.transparentize(95%), stroke: none, radius: 0.2, {
            line((0.03, 0.03), (2.97, -2.97))
            line((2.97, -2.97), (2.97 * 2, -2.97))
            line((2.97 * 2, -2.97), (2.97*2, 0.03))
            line((2.97*2, 0.03), (2.97, 2.97))
            line((2.97, 2.97), (0.03, 0.03))
          })
        }

        if (not back and x == 1) or (back and x == 0) {
          rect((0.03, 0.03), (2.97, 2.97), fill: black.transparentize(95%), stroke: none, radius: 0.2)
        }
      })
    }
  })
...
#align(center, [
  ...
  #place(bottom + center, [Our submission to SIGHORSE 2025, the Purdue Hackers journal \ #underline(text(fill: blue)[https://sig.horse/])])
])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); U])
    cube("wwwwwwwww rrrgggggg bbbrrrrrr", offset: (-9.9, 0))
    content((-7, 2), [#set text(1.5em); U2])
    cube("wwwwwwwww bbbgggggg ooorrrrrr", offset: (-4.9, 0))
    content((-2, 2), [#set text(1.5em); U'])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-17, -1), [#set text(2em); #sym.circle.dotted], anchor: "west")
    ...
    content((-17, -7), [#set text(2em); #sym.circle.dotted;2], anchor: "west")

    cube("wwwwwwwww bbbgggggg ooorrrrrr", offset: (-9.9, -6))
    cube("wwwwwwwww ggggggbbb rrrrrrooo", offset: (-4.9, -6))
    cube("wwywwywwy ggbggbggb rrrrrrrrr", offset: (0.1, -6))
    cube("ywwywwyww bggbggbgg rrrrrrrrr", offset: (5.1, -6))
    cube("wwwwwwyyy ggggggggg orrorrorr", offset: (10.1, -6))
    cube("yyywwwwww ggggggggg rrorrorro", offset: (15.1, -6))

    content((-17, -13), [#set text(2em); #sym.circle.dotted;#sym.quote.single], anchor: "west")

    cube("wwwwwwwww ooogggggg gggrrrrrr", offset: (-9.9, -12))
    cube("wwwwwwwww ggggggrrr rrrrrrbbb", offset: (-4.9, -12))
    cube("wwbwwbwwb ggwggwggw rrrrrrrrr", offset: (0.1, -12))
    cube("gwwgwwgww yggyggygg rrrrrrrrr", offset: (5.1, -12))
    cube("wwwwwwrrr ggggggggg yrryrryrr", offset: (10.1, -12))
    cube("ooowwwwww ggggggggg rrwrrwrrw", offset: (15.1, -12))
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); ??])
    cube("wgwwgwwgw gyggyggyg rrrrrrrrr", offset: (-9.9, 0))
    content((-7, 2), [#set text(1.5em); R' L])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-10, 1.5), [#set text(1.5em); UFR])
    content((-16, -1.3), [#set text(1.5em); FL])
    cube("wwwwwwwww ggggggggg rrrrrrrrr", offset: (-9.9, 0))

    line((-10, 0.8), (-12, -1), mark: (end: "straight"))
    line((-15.3, -1.3), (-14.2, -1.3), mark: (end: "straight"))
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-2, 2), [#set text(1.5em); L2 D2 L' U' L D2 L' U L'])
    cube("ywwwwwwww ggggggggg rrrrrrrry", offset: (-2.5, 0))
    cube("bbbbbbbbb oyoyyyyyy woroooooo", offset: (2.5, 0), back: true)

    line((0.7, 0.7), (0.7, -1), mark: (end: "straight"))
    line((0.7, -1), (2.2, -1.8), mark: (end: "straight"))
    line((2.2, -1.8), (0.7, 0.7), mark: (end: "straight"))
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); "Zero"])
    cube("wwwwwwwww ggggggggg rrrrrrrrr", offset: (-9.9, 0))
    content((-7, 2), [#set text(1.5em); "One"])
    cube("wwwwwwggg rrrggyggy wbbrrrrrr", offset: (-4.9, 0))
    content((-2, 2), [#set text(1.5em); "Two"])
    cube("gwwgwwyyr rrwggbggb goorrbrrb", offset: (0.1, 0))
    content((3, 2), [#set text(1.5em); ...])
    content((8, 2), [#set text(1.5em); "104"])
    cube("wwbwwbwwr oowggwggw grrgrrgrr", offset: (10.1, 0))
    content((13, 2), [#set text(1.5em); "105"])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); (R U) × ???])
    cube("oybbwgywr grwggwggb grobrgyob", offset: (-9.9, 0))
    content((-5, 2), [#set text(1.5em); (R U) × #underline()[0]])
...
#figure(scale(40%, reflow: true, image("Goto States.png")))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-9.5, 2), [#set text(1.2em); R' F' L U' L U L F U' R #h(0.4em) (1, 0)])
    cube("obwywwwgw bwggggggg rrbrrbrrr", offset: (-9.9, 0))
    cube("orgobwbbo yybyywyyy yowboooor", offset: (-4.9, 0), back: true)
    content((2.5, 2), [#set text(1.2em); U F R' D' R2 F R' U' D #h(0.4em) (0, 1)])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-4.6, 2), [#set text(1.5em); $R U$])
    cube("wwwwwwggg rrrggyggy wbbrrrrrr", offset: (-2.5, 0))
    content((0.4, 2), [#set text(1.5em); $(R U)^3$])
    cube("yggywwbbw rrgggwggo rgyrrobbo", offset: (2.5, 0), back: false)

    circle((0.4, -1.2), radius: 1)
    circle((-4.6, -1.2), radius: 1)
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); R U R' U'])
    cube("wwowwgwwg ggyggwggg rrwbrrwrr", offset: (-9.9, 0))
    content((-6, 2), [#set text(1.5em); F L])
    cube("bwwbwwboo wggwggogg wrrwrrwrr", offset: (-3.9, 0))
    content((0, 2), [#set text(1.5em); (R U R' U') (F L)])
    cube("bwobwgroo wggwggowy wrwwrrgrr", offset: (2.1, 0))

    circle((-9, -1), fill: black, radius: 0.15)
    content((-3, -1), [#set text(2em); $=$])
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); A])
    cube("wwowwgwwg ggyggwggg rrwbrrwrr", offset: (-9.9, 0))
    content((-6, 2), [#set text(1.5em); ()])
    cube("wwwwwwwww ggggggggg rrrrrrrrr", offset: (-3.9, 0))
    content((0, 2), [#set text(1.5em); (A) () = A])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); A B])
    cube("wwrwwgwwg rryggyggy rrbrrbrrb", offset: (-9.9, 0))
    content((-6, 2), [#set text(1.5em); C])
    cube("wwwwwwooo ggggggggg wrrwrrwrr", offset: (-3.9, 0))
    content((0, 2), [#set text(1.5em); (A B) (C) = A B C])
    ...
    content((-12, 2), [#set text(1.5em); A])
    cube("wwwwwwwww rrrgggggg bbbrrrrrr", offset: (-9.9, 0))
    content((-6, 2), [#set text(1.5em); B C])
...
We also have to assume that the group is _finite_, because for infinite groups it's easily possible for this to not work. A simple counterexample would be taking your group to be the integers under addition. This follows all of the group axioms and if you add one to itself over and over, it will never loop around back to one. Thankfully, the Rubik's Cube (and all twisty puzzles) are finite groups, so we can get away with only caring about those.
...
#figure(scale(20%, reflow: true, image("TooManyPigeons.jpg")), caption: [10 pigeons in 9 holes. The top-left hole has two pigeons. Image source: @pigeons-in-holes], numbering: none)
...
#figure(scale(40%, reflow: true, image("Stickered Cube.png")))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    line((-9.5, -1), (-7.5, -1), mark: (end: "straight"))
    content((-5, 2), [#set text(1.5em); R])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-12, 2), [#set text(1.5em); ()])
    cube("wwwwwwwww ggggggggg rrrrrrrrr", offset: (-9.9, 0))
    content((-6, 2), [#set text(1.5em); R U])
    cube("wwwwwwggg rrrggyggy wbbrrrrrr", offset: (-3.9, 0))
    content((0, 2), [#set text(1.5em); R U F])
    cube("wwwwwwooy ggrggryyr gbbgrrgrr", offset: (2.1, 0))

    circle((0, -2.2), radius: 1)
    circle((-6, -1.2), radius: 1)
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    cube("owoywoowb bgybgwybg oggorgwrw", offset: (-2.5, 0))
    cube("wbyrbybwr rryyyyrog bbgoogrrw", offset: (2.5, 0), back: true)

    line((-2.15, -3.5), (-2.15, -5.8), mark: (end: "straight"))

    translate((0, -7))

    cube("nbnbbnnbn nnbbbbbbn nbnnnbbnb", offset: (-2.5, 0))
    cube("bnbnbbnbn nnbbbbnnn nnnnnnnnb", offset: (2.5, 0), back: true)
}))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    cube("bbbbbbbbn nnnbbbnnn bnnnnnnnn", offset: (-2.5, 0))
    cube("bbbbbbbbn nnbbbbnnn nnnnnnnnn", offset: (2.5, 0))

    content((-4.6, 2), [#set text(2em); $1$])
    content((0.4, 2), [#set text(2em); $2$])
    circle((0.4, -1.2), radius: 1)
    circle((-4.6, -1.2), radius: 1)
}))
...
Is there any other arrangement of pieces that is unsolvable? Actually no! You can show this by counting the number of ways that you can take apart and randomly put together a Rubik's Cube, then dividing by three because two thirds of those positions will be unsolvable due to the corner orientation sum being non-zero. Then divide by two for edge orientation sum, and then divide by two again for parity. You will see that the number you get is $4.3·10^19$ which is exactly the size of the Rubik's Cube group.
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-2, 2), [#set text(1.5em); $R U$])
    cube("wwwwwwggg rrrggyggy wbbrrrrrr", offset: (-2.5, 0))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-2, 2), [#set text(1.5em); $(R U)^3$])
    cube("yggywwbbw rrgggwggo rgyrrobbo", offset: (-2.5, 0))
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-2, 2), [#set text(1.5em); $(R U)^7$])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-2, 2), [#set text(1.5em); $(R U)^5$])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-2, 2), [#set text(1.5em); $(R U)^15$])
...
#figure(cetz.canvas(length: 15pt, {
    ...
    content((-9.5, 2), [#set text(1.2em); A = R' F' L U' L U L F U' R])
    cube("obwywwwgw bwggggggg rrbrrbrrr", offset: (-9.9, 0))
    cube("orgobwbbo yybyywyyy yowboooor", offset: (-4.9, 0), back: true)
    content((2.5, 2), [#set text(1.2em); B = U F R' D' R2 F R' U' D])
    cube("wwwwwywwg ggrwgyggb wgrbrryyy", offset: (2.1, 0))
    cube("bbbbbbooy ggoryyrrr boooooyro", offset: (7.1, 0), back: true)
}))
...
}), caption: figure.caption(position: top, text(1.2em)[$R'$ $\U2$ $L'$ $D'$ $R'$]), supplement: none)
...
#grid(
  ...
  }), caption: figure.caption(position: top, text(1.5em)[Cube $1$\ $R$ $U$ $R'$ $U'$]), supplement: none),
  figure(cetz.canvas(length: 15pt, {
      import cetz.draw : *

      cube("wwwwwwoob ggwrggwgg rggrrrrrr", offset: (-2.5, 8))
      cube("rbbbbbbbb yyyyyyyyg ooooooowy", offset: (2.5, 8), back: true)
  }), caption: figure.caption(position: top, text(1.5em)[Cube $2$\ $F$ $U$ $F'$ $U'$]), supplement: none)
)
...
#figure(cetz.canvas(length: 130pt, {
  import cetz.draw: *
  ...
  ortho(
    ...
    y: 28deg,
    {
      ...
      arc((1.28, 1.14, -0.1), start: 0deg, stop: 330deg, radius: (1.5/13, 1.2/13), mark: (end: ">", scale: 0.4))
      ...
      arc((0.61, 1.35, 0.5), start: 37deg, stop: 364deg, radius: (1.7/13, 1/13), mark: (end: ">", scale: 0.4))
      ...
      arc((1.46,0.61,0.5), start: 100deg, stop: 430deg, radius: (1.2/13, 1.4/13), mark: (end: ">", scale: 0.4))
      content((1.52, 0.73, 0.5), text(size: 13pt)[$2$x])
      content("fourth-line.end", text(size: 13pt)[#move(dx: 3pt, dy: -22pt)[$S_(\R2)$]])
    }
  )
}), caption: text(1.2em)[The 48 symmetries of the cube], supplement: none)
...
#align(center)[#grid(
  ...
  }), caption: figure.caption(position: top, text(1.5em)[$R$ $U$]), supplement: none),

  figure(cetz.canvas(length: 15pt, {
      cube("wwrwwrwwr oowgggggg gggyrryrr", offset: (0, 7.5))
  }), caption: figure.caption(position: top, text(1.5em)[$F'$ $U'$]), supplement: none)
)]
...
#figure(diagram(
  ...
  edge(<fourth>, <sixth>),
), caption: text(size: 12pt)[IDA\* pathmax at $"depth"=5, "depth limit"=8$], supplement: none)
